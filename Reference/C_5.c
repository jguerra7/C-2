...
void main(){
    ...
    // test by kagaya testing somthing if usuer put a wrong data type

	struct dog cujo = {"Cujo", "Saint Bernard", 90, 264};
	// puting a wrong data type get an error puting a
	// data evaluation is needed
	//struct dog cujo = {"", "Saint Bernard", 90, 264};
